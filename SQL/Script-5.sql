...
/*
3. 사원테이블에서 전체사원의 이름, 생일, 만나이(as 만나이), 입사일, 
입사일수(as 입사일수,입사한지 500일후(as 입사500일후)의 날짜를 만드시오 */
...
조건2(마일리지구분) : 마일리지가 100000점 이상이면 'VVIP', 10000점 이상이면 'VIP',
	나머지는 '일반고객'으로 표현*/

select 담당자명, 고객회사명, 도시, 마일리지 from 고객
where 
